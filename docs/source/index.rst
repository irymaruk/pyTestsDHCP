Документация к модулю pyTestsDHCP
*********************************
...
Вобще в тестовом сценарии можно писать любой python код, действия не ограничены возможностями объекта *User*
...
.. note::
    ...
    Например, если в вашем файле тестовых сценариев указано два теста именованых как *test_1* и *test_2*, то указав
    в start.bat ключ с параметром *-k test_2* будет выполнен только тест *test_2*.
